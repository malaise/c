SUBDIRS := boolean mutex timeval socket socket_evt rusage sem_util sig_util\
 wait_evt get_line vt100\
 16_unali Poing adjtime asc ask byte_swapping catlock cirtail\
 delay dt enquire forker formfeed fread_float gettimeofdays gorgy html2ascii\
 init_so ipm ipx\
